...
init: function() {
	      ...
	      //SDK customization begin here - adding json button only for root
	      this.editjson_holder = this.theme.getModal();
	      this.editjson_button = this.getButton('JSON','edit','Edit JSON');
	      this.editjson_button.style.float = "right";
	      ...
	      this.root_container.appendChild(this.editjson_button);
	      this.root_container.appendChild(this.editjson_holder);
	      //SDK customization end here
